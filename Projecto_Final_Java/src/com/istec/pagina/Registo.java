...
public class Registo extends JFrame {
	...
	public Registo() {
		...
		pwd = new PlaceholderPasswordField();
		pwd.setOpaque(true);
		pwd.setPlaceholder("Confirmar Password");
		pwd.setBounds(99, 255, 179, 26);
		MenuLogin.add(pwd);
		...
		Register.setBounds(238, 325, 117, 29);
		MenuLogin.add(Register);
		comboBox = new JComboBox();
		comboBox.setBounds(99, 292, 179, 22);
        MenuLogin.add(comboBox);
        comboBox.addItem("Restauração");
        comboBox.addItem("Farmacia");
        comboBox.addItem("Oficina");
